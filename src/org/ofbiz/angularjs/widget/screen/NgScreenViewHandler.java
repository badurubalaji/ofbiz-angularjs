...
public class NgScreenViewHandler implements ViewHandler {
    
    public final static String module = NgScreenViewHandler.class.getName();
    ...
    public void render(String name, String page, String info,
        ...
        try {
            ...
            NgScreenStringRenderer ngScreenStringRenderer = new MacroNgScreenRenderer();
            NgScreenRenderer renderer = new NgScreenRenderer(response.getWriter(), null, ngScreenStringRenderer);
