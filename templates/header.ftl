<html>
    <head>
        <script src="/images/jquery/jquery-1.8.2.min.js"></script>
        <script src="/angularjs/images/js/angular.min.js"></script>
        <script src="/angularjs/images/js/ui-bootstrap-0.4.0.min.js"></script>
        <script src="/angularjs/images/js/ui-bootstrap-tpls-0.4.0.min.js"></script>
